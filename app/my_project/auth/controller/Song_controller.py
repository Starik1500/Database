...
@swag_from({
    'tags': ['Song'],
    'parameters': [
        {'name': 'song_id', 'in': 'path', 'type': 'integer', 'required': True}
    ],
    'responses': {
        200: {
            'description': 'Playlists containing the song',
            'schema': {
                'type': 'array',
                'items': {
                    'type': 'object',
        ...
        404: {'description': 'No playlists found for this song'}
    }
})
